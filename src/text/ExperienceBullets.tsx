...
export const experienceBullets = {
    "GAP_YEAR_BULLET1": "Teach part time as a surf instructor: coordinate lessons and help 100+ aspiring surfers learn basic technique, in both English and Chinese.",
    ...
    "GAP_YEAR_BULLET3": "Dedicate time to various personal projects including this portfolio website, mandarin studies, and music production.",
    ...
    "AMAZON_BULLET2": "Obtain proficiency with over 10 new technologies within a 3 month span.",
    "AMAZON_BULLET3": "Collaborate with and learn from a highly skilled team of developers and product managers within varying areas of expertise.",
    ...
    "TA_BULLET2": "Facilitate group lessons and provide individual academic support to over 80 students.",
