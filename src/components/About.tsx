  ...
  return (
    <div id="about" className="about">
      ...
      <div className="about__content-container">
        <div
          id="section1"
          className={`about__content-section ${playfairDisplay.className}`}
        >
          {aboutSections["SECTION1"]}
        </div>
        <div
          id="section2"
          className={`about__content-section ${playfairDisplay.className}`}
        >
          {aboutSections["SECTION2"]}
        </div>
        <div
          id="section3"
          className={`about__content-section ${playfairDisplay.className}`}
        >
          {aboutSections["SECTION3"]}
        </div>
      </div>
    </div>
  );
