...
const ExperienceCard: React.FC<ExperienceCardProps> = ({
  ...
  return (
    <div className="experience__card-subcontainer">
      <div
        className={clsx("experience__card", {
          "experience__card-expand": moreInfo,
        })}
      >
        <div className={`experience__card-time ${playfairDisplay.className}`}>
          {time}
        </div>
        <div className="experience__card-divider1"></div>
        <div
          className={`experience__card-position ${playfairDisplay.className}`}
        >
          {position}
        </div>
        ...
        <div className="experience__card-organization-container">
          ...
          <div
            className={`experience__card-organization ${playfairDisplay.className}`}
          >
            {organization}
          </div>
        </div>
        ...
        <div
          className={`experience__card-location ${playfairDisplay.className}`}
        >
          {location}
        </div>
      </div>
      <div
        className={clsx("experience__expand-container", {
          "experience__expand-container-open": moreInfo,
        })}
      >
        <ul style={{ listStyleType: "circle", marginBottom: "10px" }}>
          {contentList}
        </ul>
      </div>
      <button onClick={() => setMoreInfo(!moreInfo)}>
        <AiOutlineDown
          className={clsx("experience__expand-arrow", {
